...
class ViewControllerMatchedDisplay: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("SECOND VC RECS: \(recsList)")
        print("SECOND VC PRIORITIES: \(priorities)")
        matchedClubsCollection.reloadData()
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        print(self.recsList[indexPath.item])
        print(priorities[indexPath.item])
